...
{
public:
    typedef std::list<XPCSocket*> SOCKETLIST;
    typedef std::map<int,std::string > SOCKETFD_2_CLIENT_NAME_MAP;
    typedef std::map<int,CMOOSThread> SOCKETFD_2_UDP_THREAD_MAP;
    ...
    */
    ...
    bool UdpThreadLoop(XPCSocket* cSocket);
    ...
    */
    bool Run(long lPort, std::string transportProtocol, bool bDisableNameLookUp = false,int num_ports = 0, int min_port = 0, int iReadTimeout = 5);
...
protected:
    ...
    */
    ...
    virtual bool OnAbsentClient(XPCSocket* pClient);
    ...
    virtual unsigned char* getSessionKey(XPCSocket *pSocket);
    ...
    SOCKETFD_2_UDP_THREAD_MAP m_Socket2UdpThreadMap;
    ...
    @see ListenLoop*/
    virtual bool    OnNewClient(XPCSocket * pNewClient,char * sName);
    ...
    long    m_lListenPort;
    std::string m_sTransportProtocol;
