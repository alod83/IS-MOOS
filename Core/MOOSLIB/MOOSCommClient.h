...
public:
    ...
    */
    bool Run(const char * sServer,long lPort, const char * sMyName, std::string transportProtocol, double dFundamentalFreq=5, int iReadTimeout = 5, short int iUDPReadTime = 5);
    ...
    bool SetCommsTick(double dCommsTick);
